...
# divider output
create_generated_clock [get_pins crgu_inst/clk_out2] -name clk_20m   -source [get_pins crgu_inst/clk_100m]    -master_clock clk_100m  -divide_by 5  -add
set_clock_uncertainty -setup 0 [get_clocks clk_20m]
set_clock_uncertainty -hold 0.3 [get_clocks clk_20m]

# invert output
create_generated_clock [get_pins crgu_inst/clk_in_inv] -name clk_100m_inv   -source [get_pins crgu_inst/clk_100m]    -master_clock clk_100m  -divide_by 1  combination -invert  -add
